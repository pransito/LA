...
setwd(pfad_results)
save(file="effects_under_0_51_majrev.RData",list=c("effects_under_0"))
load("effects_under_0_51_majrev.RData")
...
setwd(pfad_results)
save(file="boot_la_compl_mod_no_cov51_majrev.RData", list=c("boot_la"))
...
setwd(pfad_results)
save(file="effects_under_0_age51_majrev.RData",list=c("effects_under_0_age"))
load("effects_under_0_age51_majrev.RData")
